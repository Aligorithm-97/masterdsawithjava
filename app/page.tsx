  ...
  const features = [
    {
      ...
      description: 'Fundamental Java programming concepts, OOP principles, and best practices',
      icon: (
    ...
    {
      title: 'Advanced Java',
      description: 'Collections, Streams, Lambda expressions, Generics, and more',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'DSA Solutions',
      description: 'Detailed solutions for data structures and algorithm problems',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Selected problems from LeetCode, HackerRank, and other platforms',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const recentPosts = [
    {
      ...
      date: '2024-01-15',
      readTime: '8 min',
      excerpt: 'Explore all components of the Java Collections Framework in detail.'
    },
    {
      ...
      date: '2024-01-12',
      readTime: '12 min',
      excerpt: 'Different algorithmic approaches for one of LeetCode’s most popular problems.'
    },
    {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10 max-w-4xl mx-auto leading-relaxed">
              Learn Java core concepts, discover advanced programming techniques, and improve your algorithm skills by solving DSA problems.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
              <div className="text-center animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Java Courses</div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Improve your programming skills with comprehensive Java and DSA educational content
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-16 h-16 bg-[#23272f] rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  {feature.icon}
                </div>
      ...
      <section className="py-24 bg-[#18181b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-100 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            Improve your programming skills with step-by-step guides, visual explanations, and practical examples.
          </p>
          <Link
            href="/java-core"
