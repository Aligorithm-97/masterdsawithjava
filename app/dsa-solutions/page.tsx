  ...
  const categories = [
    {
      ...
      problems: [
        ...
        { title: 'Container With Most Water', difficulty: 'Medium', solutions: 2 },
    ...
    },
    {
      ...
      problems: [
        ...
        { title: 'Longest Substring Without Repeating Characters', difficulty: 'Medium', solutions: 2 },
        { title: 'Longest Palindromic Substring', difficulty: 'Medium', solutions: 3 },
        { title: 'Regular Expression Matching', difficulty: 'Hard', solutions: 2 },
    ...
    },
    {
      ...
      problems: [
        ...
        { title: 'Detect Cycle in Linked List', difficulty: 'Medium', solutions: 2 },
        { title: 'Merge Two Sorted Lists', difficulty: 'Easy', solutions: 2 },
        { title: 'Remove Nth Node From End', difficulty: 'Medium', solutions: 2 },
    ...
    },
    {
      ...
      problems: [
        { title: 'Binary Tree Inorder Traversal', difficulty: 'Easy', solutions: 3 },
        { title: 'Maximum Depth of Binary Tree', difficulty: 'Easy', solutions: 2 },
        { title: 'Validate Binary Search Tree', difficulty: 'Medium', solutions: 2 },
        { title: 'Lowest Common Ancestor', difficulty: 'Medium', solutions: 2 },
        { title: 'Serialize and Deserialize Binary Tree', difficulty: 'Hard', solutions: 2 }
      ],
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      problems: [
        ...
        { title: 'Longest Increasing Subsequence', difficulty: 'Medium', solutions: 2 },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-[#18181b] shadow-sm border-b border-[#23272f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              Veri yapıları ve algoritma problemlerinin detaylı çözümleri. 
              Her problem için farklı yaklaşımlar ve optimizasyon teknikleri.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Farklı veri yapıları ve algoritma türlerine göre organize edilmiş problemler
            </p>
          </div>
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  <div className={`w-16 h-16 bg-[#23272f] rounded-2xl flex items-center justify-center text-white mr-4`}>
                    {category.icon}
                  </div>
                  <div>
                ...
                <div className="space-y-3 mb-6">
                  {category.problems.map((problem, problemIndex) => (
                    <div
                      key={problemIndex}
                      className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200 group"
                    >
                      ...
                      <Link
                        href={`/dsa-solutions/${category.title.toLowerCase().replace(/\s+/g, '-')}/${problem.title.toLowerCase().replace(/\s+/g, '-')}`}
      ...
      <section className="py-20 bg-[#18181b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center group animate-fade-in-up bg-[#23272f]" style={{ animationDelay: '200ms' }}>
            ...
            <div className="text-center group animate-fade-in-up bg-[#23272f]" style={{ animationDelay: '400ms' }}>
              <div className="w-20 h-20 bg-[#23272f] rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="text-center group animate-fade-in-up bg-[#23272f]" style={{ animationDelay: '600ms' }}>
              <div className="w-20 h-20 bg-[#23272f] rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="text-center group animate-fade-in-up bg-[#23272f]" style={{ animationDelay: '800ms' }}>
              <div className="w-20 h-20 bg-[#23272f] rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
