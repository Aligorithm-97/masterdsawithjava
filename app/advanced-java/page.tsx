        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Java\'nın gelişmiş özelliklerini öğrenin. Collections, Streams, Lambda expressions, 
              Generics ve daha fazlası ile profesyonel Java programlama.
            </p>
          </div>
        </div>
      </section>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <span className="text-3xl mr-3 font-mono">{topic.icon}</span>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <Link
                      href={`/advanced-java/${topic.title.toLowerCase().replace(/\s+/g, '-')}`}
      ...
      <section className="py-16 bg-[#18181b]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Modern Java programlama tekniklerini öğrenin ve profesyonel seviyeye ulaşın
          </p>
          <Link
