        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#23272f] rounded-xl p-8 border border-gray-700">
            ...
            <p className="text-gray-300 mb-6">
              Learn horizontal and vertical scaling strategies, load balancing,
              and how to handle increasing user loads.
            </p>
          ...
          <div className="bg-[#23272f] rounded-xl p-8 border border-gray-700">
            ...
            <p className="text-gray-300 mb-6">
              Understand microservices architecture, service communication, and
          ...
          <div className="bg-[#23272f] rounded-xl p-8 border border-gray-700">
            ...
            <p className="text-gray-300 mb-6">
              Learn optimization techniques, monitoring, and how to identify and
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-yellow-400">• Memory Management</div>
            </div>
          </div>
          ...
          <div className="bg-[#23272f] rounded-xl p-8 border border-gray-700">
            ...
            <p className="text-gray-300 mb-6">
              Study real-world system designs from companies like Netflix, Uber,
              Twitter, and learn from their architectures.
            </p>
            <div className="space-y-2">
