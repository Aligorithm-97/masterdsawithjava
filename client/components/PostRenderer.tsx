      ...
      case "image":
        ...
        return (
          <div key={index} className={`${isPreview ? 'mb-4' : 'mb-12'}`}>
            <div className={`relative ${isPreview ? '' : 'rounded-xl overflow-hidden shadow-2xl'}`}>
              <img 
                src={block.url} 
      ...
      case "code":
        return (
          <div key={index} className={`${isPreview ? 'mb-4' : 'mb-12'} relative`}>
            ...
            <pre className={`bg-gray-800 text-green-200 rounded-lg border border-gray-700 overflow-x-auto font-mono shadow-lg ${
              isPreview 
                ? 'p-3 text-xs' 
        ...
        return (
          ...
          >
            <div className="flex items-start">
              <svg className="w-6 h-6 mr-3 mt-1 text-yellow-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
